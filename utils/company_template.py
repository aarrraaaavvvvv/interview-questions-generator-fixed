...
PARTNER_LOGO_URLS = {
    ...
    "Default": "https://raw.githubusercontent.com/aarrraaaavvvvv1/Interview_Questions_Generator_New/refs/heads/main/assets/logos/iitk-accredian-banner.png"
}
...
PARTNER_LOGOS = {
    ...
    # Default falls back to the IIT Kanpur banner which is always present
    "Default": os.path.join("assets", "logos", "iitk-accredian-banner.png")
}
